...
__all__ = ['P3DA_ResNet', 'p3da_resnet18', 'p3da_resnet34', 'p3da_resnet50', 'p3da_resnet101', 'p3da_resnet103',
           'p3da_resnet152', 'p3da_resnext50_32x4d', 'p3da_resnext101_32x8d',
           'p3da_wide_resnet50_2', 'p3da_wide_resnet101_2']
...
class P3DA_ResNet(nn.Module):

    def __init__(self, block, layers, num_classes=400, dropout_ratio=0.5, zero_init_residual=False,
...
def _p3da_resnet(arch, block, layers, **kwargs):
    model = P3DA_ResNet(block, layers, **kwargs)
    return model


def p3da_resnet18(**kwargs):
    ...
    """
    return _p3da_resnet('resnet18', BasicBlock, [2, 2, 2, 2],
                   **kwargs)


def p3da_resnet34(**kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _p3da_resnet('resnet34', BasicBlock, [3, 4, 6, 3],
                   **kwargs)


def p3da_resnet50(**kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _p3da_resnet('resnet50', Bottleneck, [3, 4, 6, 3],
                   **kwargs)


def p3da_resnet101(**kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _p3da_resnet('resnet101', Bottleneck, [3, 4, 23, 3],
                   **kwargs)
                   
                   
def p3da_resnet103(**kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _p3da_resnet('resnet103', Bottleneck, [3, 4, 23, 3], deep_stem=True,
                   **kwargs)


def p3da_resnet152(**kwargs):
    ...
    Args:
        pooling_arch: choose the pooling architecture for last conv/res layer
    """
    return _p3da_resnet('resnet152', Bottleneck, [3, 8, 36, 3],
                   **kwargs)


def p3da_resnext50_32x4d(**kwargs):
...
def p3da_resnext101_32x8d(**kwargs):
    ...
    return _p3da_resnet('resnext101_32x8d', Bottleneck, [3, 4, 23, 3],
                   **kwargs)


def p3da_wide_resnet50_2(**kwargs):
...
def p3da_wide_resnet101_2(**kwargs):
    ...
    """
    kwargs['width_per_group'] = 64 * 2
    return _p3da_resnet('wide_resnet101_2', Bottleneck, [3, 4, 23, 3],
                   **kwargs)
