...
__all__ = ['P3DA_ResNet', 'p3da_resnet18', 'p3da_resnet34', 'p3da_resnet50', 'p3da_resnet101',
...
def p3da_resnet50(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _p3da_resnet('resnet50', Bottleneck, [3, 4, 6, 3], pretrained, progress,
                   **kwargs)


def p3da_resnet101(pretrained=False, progress=True, **kwargs):
...
def p3da_resnext101_32x8d(pretrained=False, progress=True, **kwargs):
...
def p3da_wide_resnet101_2(pretrained=False, progress=True, **kwargs):
